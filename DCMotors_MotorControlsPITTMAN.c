...
#define ERROR_DEADBAND	0.01
#define DATA_LENGTH     16
#define PI  3.141592653
#define frequency  1500 	       // Let's check the kinematics this many times per second
#define GEARRATIO  (23.0*(3.0/4.0))    // The gear ratio of the gearhead on the DC motor
#define CPR  256.0	               // The number of counts per revolution of the motor's encoder
...
static float kd = 0.005;			// Gain on the derivative error term
